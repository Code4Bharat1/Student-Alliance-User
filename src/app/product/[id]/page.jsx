...
export default function ProductDetail() {
  ...
  // Prepare a single thumbnail image (keep hook order stable by calling useMemo every render)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <div className="sticky top-8 space-y-4">
              ...
              {/* Thumbnail Gallery - show only one unique thumbnail to avoid duplicates */}
              {thumbs.length > 0 && (
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center bg-slate-900 rounded-2xl overflow-hidden border-2 border-slate-700">
                  ...
                  <motion.button
                    whileTap={{ scale: 0.9 }}
                    onClick={() =>
                      setQuantity(Math.min(product?.stocks || 10, quantity + 1))
                    }
