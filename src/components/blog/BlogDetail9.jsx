...
export default function BlogsDetail9() {
  return (
    <div className="px-2 py-2 md:px-16 lg:px-32 bg-bg-section text-text-heading">
      {/* Hero Section */}
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              >
                <span className="bg-clip-text text-4xl text-transparent bg-gradient-to-r from-brand-primary to-brand-primary">
              ...
              >
                <div className="bg-bg-card px-6 py-3 rounded-lg shadow-md border border-border-primary">
                  <div className="text-sm text-text-muted">Potential Earnings</div>
                  <div className="text-2xl font-bold text-brand-primary">₹1,000+/hour</div>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-bg-card px-4 py-2 rounded-lg shadow-sm border border-border-primary">Graduates</div>
              <div className="bg-bg-card px-4 py-2 rounded-lg shadow-sm border border-border-primary">Freshers</div>
              <div className="bg-bg-card px-4 py-2 rounded-lg shadow-sm border border-border-primary">Experienced Tutors</div>
            </div>
          </motion.div>
        </motion.div>
      ...
      <section className="mb-24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-3 text-brand-primary">No Need to Search for Students</h3>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-3 text-brand-primary">Teach from Anywhere</h3>
              <p className="text-text-primary">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-3 text-success">High Earning Potential</h3>
              <p className="text-text-primary">
          ...
          <div className="md:w-1/2 p-8 md:p-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1 text-brand-primary">Flexible Schedule</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1 text-brand-primary">Better Student Engagement</h3>
                  <p className="text-text-secondary">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1 text-success">Global Reach</h3>
                  <p className="text-text-secondary">
