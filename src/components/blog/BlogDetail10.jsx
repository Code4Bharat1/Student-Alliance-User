...
<section className="mb-10 relative w-full overflow-hidden">
  ...
  >
    <div className="flex flex-col lg:flex-row items-center gap-12">
      ...
      >
        <div className="relative rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="absolute -bottom-4 -right-4 bg-bg-card px-6 py-3 rounded-lg shadow-lg border border-border-primary">
            <div className="text-sm text-text-muted">Starting from</div>
            <div className="text-2xl font-bold text-brand-primary">₹90,000</div>
          </div>
        </div>
      </motion.div>
    </div>
    ...
    >
      <div className="text-text-muted font-medium">Trusted by:</div>
      <div className="flex flex-wrap justify-center gap-4">
        <div className="bg-bg-card px-4 py-2 rounded-lg shadow-sm border border-border-primary">100+ Schools</div>
        <div className="bg-bg-card px-4 py-2 rounded-lg shadow-sm border border-border-primary">5-Star Reviews</div>
        <div className="bg-bg-card px-4 py-2 rounded-lg shadow-sm border border-border-primary">Certified Partners</div>
      </div>
    </motion.div>
  </motion.div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                <span className="bg-bg-badge text-brand-primary px-3 py-1 rounded-full text-sm">AIWaft</span>
                <span className="bg-bg-badge text-brand-primary px-3 py-1 rounded-full text-sm">Maxhub</span>
                <span className="bg-bg-badge text-brand-primary px-3 py-1 rounded-full text-sm">Viewsonic</span>
              </div>
